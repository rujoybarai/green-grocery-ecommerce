...
const vegBtn=document.querySelector(".vegetables");

allBtn.addEventListener("click", (e)=>{
e.preventDefault();
return getCardDetail("./allproduct.json");
});
vegBtn.addEventListener("click", (e)=>{
e.preventDefault();
return getCardDetail("./vegetable.json");
});
...
e.preventDefault();
return getCardDetail("./fruits.json");
...
const shopNowBtn2=document.querySelector("#shop-now");
shopNowBtn2.addEventListener("click", (e)=>{
  e.preventDefault();
  window.location.href="shoop.html";
});
